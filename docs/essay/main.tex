...
\newcommand{\pieparizq}{TODO: Pie página izquierda}
...
\include{src/estado_del_arte}
\include{src/definicion_del_proyecto}
\include{src/requisitos}
\include{src/disenho}
\include{src/implementacion}
\include{src/pruebas}
\include{src/mantenimiento}
\include{src/uso_de_la_aplicacion}
\include{src/conclusiones}
\include{src/lineas_de_trabajo_futuras}
...
\include{src/manual_de_usuario}
\include{src/framework_mvc_propio}
\include{src/programacion_asincrona}
\include{src/api_servicio_web_fpga}
