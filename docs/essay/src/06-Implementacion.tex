...
Los archivos de código más relevantes de la implementación del \gls{back-end} se muestran en la Figura~\ref{fig:arbol_codigo}.
...
\begin{figure}[!htp]
  \begin{center}
    ...
    \hspace{1cm}
    \includegraphics[width=0.25\textwidth,clip=true]{capturas/arbol_frontend}
