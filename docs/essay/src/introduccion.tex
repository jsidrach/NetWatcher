...
\begin{itemize}
  ...
  Esta interfaz permitirá de manera visual tanto conocer el estado actual de la sonda de red como configurarla para reproducir o capturar tráfico de red.
